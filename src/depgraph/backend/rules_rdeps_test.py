...
def test_depgraph_rule_direct_rdeps(rule_runner: RuleRunner) -> None:
    ...
    assert json.loads(result.stdout) == {
        "project/commons.py": ["project/file1.py", "project/file2.py"],
        "project/file1.py": [],
        "project/file2.py": [],
    }


def test_depgraph_rule_transitive_rdeps(rule_runner: RuleRunner) -> None:
    rule_runner.write_files(
        {
            "project/file1.py": "",
            "project/file2.py": "",
    ...
    assert json.loads(result.stdout) == {
        "project/file1.py": [],
        "project/file2.py": ["project/file1.py"],
        "project/file3.py": ["project/file1.py", "project/file2.py"],
    }
